...
use {{project_name}}::{{{class_name}} as AocDay, INPUT_STR}; // Import functions from your library
...
criterion_group!({{project_name}}, bench_part_01_final, bench_part_02_final);
criterion_main!({{project_name}});